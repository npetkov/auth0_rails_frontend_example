angular.module('auth0-rails-frontend-example', ['angular-jwt']);

angular.module('auth0-rails-frontend-example').config(['$httpProvider', 'jwtInterceptorProvider',
...
angular.module('auth0-rails-frontend-example').run(['$http', 'ApiTokenFetcher',
